...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('d1t4grugoz', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => ($this->targetDirs[3].'/modules/productcomments/src/Entity')]);
        $e->addExcludePaths([0 => ($this->targetDirs[3].'/modules/productcomments/src/Entity/index.php')]);
    ...
    protected function getPrestashop_Addons_ClientApiService()
    {
        ...
        $instance->setSslVerification(($this->targetDirs[1].'/prod/cacert.pem'));
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'ps_cache_dir': $value = ($this->targetDirs[1].'/prod/'); break;
            case 'prestashop.addons.api_client.verify_ssl': $value = ($this->targetDirs[1].'/prod/cacert.pem'); break;
