...
class __TwigTemplate_f59a4cab61605509b591ab5ef0d8ab001b0cb2ad328492822891b09bbe3325cc extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@PrestaShop/Admin/Multistore/header.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@PrestaShop/Admin/Multistore/header.html.twig"));
    ...
    {
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e = $this->env->getExtension("Symfony\\Bundle\\WebProfilerBundle\\Twig\\WebProfilerExtension");
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "multistore_header"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "multistore_header"));

        // line 26
        echo "  ";
        if ((($context["isMultistoreUsed"] ?? $this->getContext($context, "isMultistoreUsed")) &&  !(null === $this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "request", [])))) {
            // line 27
            echo "    <div class=\"header-multishop";
            if (($context["isAllShopContext"] ?? $this->getContext($context, "isAllShopContext"))) {
                echo " header-multishop-allshops";
            } elseif (twig_test_empty($this->getAttribute(($context["currentContext"] ?? $this->getContext($context, "currentContext")), "color", []))) {
                echo " header-multishop-default";
            }
            if ((($context["isTitleDark"] ?? $this->getContext($context, "isTitleDark")) === true)) {
      ...
      <div class=\"header-multishop-top-bar\"";
            // line 28
            if ( !twig_test_empty($this->getAttribute(($context["currentContext"] ?? $this->getContext($context, "currentContext")), "color", []))) {
                echo " style=\"background-color: ";
                echo twig_escape_filter($this->env, $this->getAttribute(($context["currentContext"] ?? $this->getContext($context, "currentContext")), "color", []), "html", null, true);
                echo ";\"";
            }
            echo ">
        <div class=\"header-multishop-center js-header-multishop-open-modal\">
          ";
            // line 30
            if (($context["isShopContext"] ?? $this->getContext($context, "isShopContext"))) {
                // line 31
          ...
          ";
            // line 70
            if (($context["isGroupContext"] ?? $this->getContext($context, "isGroupContext"))) {
            ...
            echo twig_escape_filter($this->env, $this->getAttribute(($context["currentContext"] ?? $this->getContext($context, "currentContext")), "name", []), "html", null, true);
            echo "
          </h2>
      ...
      ";
          ...
          <a class=\"header-multishop-view-action\" href=\"";
                // line 81
                echo twig_escape_filter($this->env, $this->getAttribute(($context["link"] ?? $this->getContext($context, "link")), "getBaseLink", [0 => $this->getAttribute(($context["currentContext"] ?? $this->getContext($context, "currentContext")), "id", [])], "method"), "html", null, true);
      ...
      <div id=\"multishop-modal\" class=\"multishop-modal multishop-modal-hidden js-multishop-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"multishop-modal\" aria-hidden=\"true\">
        <div class=\"multishop-modal-dialog\" role=\"document\">
          <div class=\"multishop-modal-body\">
            ";
            // line 88
            if ((($context["lockedToAllShopContext"] ?? $this->getContext($context, "lockedToAllShopContext")) == false)) {
                // line 89
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
                if ( !twig_test_empty($this->getAttribute($context["group"], "shops", []))) {
                  ...
                  <span class=\"multishop-modal-color-container";
                    // line 109
                    if ((($context["isGroupContext"] ?? $this->getContext($context, "isGroupContext")) && ($this->getAttribute(($context["currentContext"] ?? $this->getContext($context, "currentContext")), "id", []) == $this->getAttribute($context["group"], "id", [])))) {
                ...
                ";
                    ...
                    <span class=\"multishop-modal-color-container";
                        // line 119
                        if ((($context["isShopContext"] ?? $this->getContext($context, "isShopContext")) && ($this->getAttribute(($context["currentContext"] ?? $this->getContext($context, "currentContext")), "id", []) == $this->getAttribute($context["shop"], "id", [])))) {
                            echo " multishop-modal-color-check";
                        }
                        echo "\">
                      <i class=\"material-icons\">check</i>
                    ...
                    ";
                        ...
                        if ($this->getAttribute($context["shop"], "hasMainUrl", [], "method")) {
                            ...
                            echo twig_escape_filter($this->env, $this->getAttribute(($context["link"] ?? $this->getContext($context, "link")), "getBaseLink", [0 => $this->getAttribute($context["shop"], "id", [])], "method"), "html", null, true);
  ...
  ";
    ...
    {
        return array (  358 => 139,  350 => 133,  343 => 132,  336 => 130,  328 => 128,  320 => 126,  318 => 125,  315 => 124,  303 => 123,  290 => 121,  283 => 119,  279 => 117,  275 => 116,  267 => 113,  254 => 111,  247 => 109,  244 => 108,  239 => 107,  232 => 103,  227 => 102,  223 => 100,  219 => 98,  217 => 97,  212 => 94,  204 => 91,  200 => 89,  198 => 88,  192 => 84,  184 => 81,  181 => 80,  179 => 79,  163 => 70,  159 => 68,  144 => 60,  135 => 58,  125 => 55,  116 => 48,  103 => 42,  92 => 38,  83 => 31,  81 => 30,  72 => 28,  58 => 27,  55 => 26,  37 => 25,);
    }
...
{% block multistore_header %}
  {% if isMultistoreUsed and app.request is not null %}
    <div class=\"header-multishop{% if isAllShopContext %} header-multishop-allshops{% elseif currentContext.color is empty %} header-multishop-default{% endif %}{% if isTitleDark is same as (true) %} header-multishop-dark{% else %} header-multishop-bright{% endif %}\">
        ...
        <div class=\"multishop-modal-dialog\" role=\"document\">
          <div class=\"multishop-modal-body\">
            ...
            <ul class=\"multishop-modal-group-list js-multishop-scrollbar\">
              ...
              {% for group in groupList if group.shops is not empty %}
  ...
  {% endif %}
{% endblock %}
", "@PrestaShop/Admin/Multistore/header.html.twig", "/var/www/html/presta/src/PrestaShopBundle/Resources/views/Admin/Multistore/header.html.twig");
    }
}
