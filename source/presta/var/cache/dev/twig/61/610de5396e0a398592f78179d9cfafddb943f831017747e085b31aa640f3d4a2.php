...
class __TwigTemplate_1a3be129f51de335e57519814599ad8b8ab55325ebdcec89f9ba13f2d24e62d7 extends \Twig\Template
{
            ...
            if ((($context["request_collector"] ?? $this->getContext($context, "request_collector")) && $this->getAttribute(($context["request_collector"] ?? $this->getContext($context, "request_collector")), "redirect", []))) {
                ...
                echo "</span>
                                ...
                                <dd>
                                    ";
                // line 33
                ((("GET" != $this->getAttribute(($context["redirect"] ?? $this->getContext($context, "redirect")), "method", []))) ? (print (twig_escape_filter($this->env, $this->getAttribute(($context["redirect"] ?? $this->getContext($context, "redirect")), "method", []), "html", null, true))) : (print ("")));
                echo "
                                    ";
                // line 34
...
{% endblock %}
", "@WebProfiler/Profiler/layout.html.twig", "/var/www/html/presta/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Profiler/layout.html.twig");
    }
}
