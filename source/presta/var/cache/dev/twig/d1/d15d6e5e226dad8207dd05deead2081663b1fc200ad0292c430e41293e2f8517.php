...
class __TwigTemplate_fa869d52f135fad227f6da1db0dc52ecad0598851763e66eff4ef51e1534bb8b extends \Twig\Template
{
    ...
    ";
        ...
        <div id=\"tree-details-container\">
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 203
                echo "                ";
                echo $context["__internal_602b25b77fb76a01c71c656c2301796740437e6f0036807e247dd0504eef4577"]->getform_tree_details($context["formName"], $context["formData"], $this->getAttribute($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "data", []), "forms_by_hash", []), $this->getAttribute($context["loop"], "first", []));
                echo "
            ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
...
{% macro form_tree_details(name, data, forms_by_hash, show) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/form.html.twig", "/var/www/html/presta/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/form.html.twig");
    }
}
