...
class __TwigTemplate_3e0a3e32e89c5c50308c81a40762c167b5732c46e63ef6beace75a65223b3694 extends \Twig\Template
{
    ...
    ";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl("themes/new-theme/img/glyph.png"), "html", null, true);
        echo "\" /></span>
        ...
        <div class=\"sf-toolbar-info-group\">
            <div class=\"sf-toolbar-info-piece\">
                ...
                <span>
                    ";
        // line 103
        $context["appVersion"] = twig_slice($this->env, twig_join_filter($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "applicationversion", [])), 0, 3);
        // line 104
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@PrestaShop/Admin/WebProfiler/config.html.twig", "/var/www/html/presta/src/PrestaShopBundle/Resources/views/Admin/WebProfiler/config.html.twig");
    }
}
