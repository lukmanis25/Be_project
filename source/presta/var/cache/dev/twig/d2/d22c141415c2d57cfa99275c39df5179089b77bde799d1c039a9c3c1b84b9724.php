...
class __TwigTemplate_12ffc552a41c57807c2a70ee8c07872a3af0d496d399e6cc51ff6e2dfb5706ba extends \Twig\Template
{
    ...
    ";
        ...
        if ($this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "route", [])) {
            ...
            ((("GET" != $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "method", []))) ? (print (twig_escape_filter($this->env, $this->getAttribute(($context["collector"] ?? $this->getContext($context, "collector")), "method", []), "html", null, true))) : (print ("")));
            echo " @</span>
        ...
        try {
            ...
            if ($this->getAttribute(($context["controller"] ?? null), "class", [], "any", true, true)) {
                ...
                if (((array_key_exists("route", $context)) ? (_twig_default_filter(($context["route"] ?? $this->getContext($context, "route")), false)) : (false))) {
                    ...
                    // line 296
                    (($this->getAttribute(($context["controller"] ?? $this->getContext($context, "controller")), "method", [])) ? (print (twig_escape_filter($this->env, (" :: " . $this->getAttribute(($context["controller"] ?? $this->getContext($context, "controller")), "method", [])), "html", null, true))) : (print ("")));
                }
                // line 299
                if (($context["link"] ?? $this->getContext($context, "link"))) {
                    echo "</a>";
...
{% macro set_handler(controller, route, method) %}
    ...
    {%- endif %}
{% endmacro %}
", "@WebProfiler/Collector/request.html.twig", "/var/www/html/presta/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/request.html.twig");
    }
}
